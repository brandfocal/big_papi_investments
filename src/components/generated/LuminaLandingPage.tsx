...
const GALLERY_IMAGES: GalleryImage[] = [{
  id: 'g1',
  src: '/website_pictures/IMG_9901.jpg',
  alt: 'Large conference aerial'
}, {
  id: 'g2',
  src: '/website_pictures/IMG_9902.jpg',
  ...
  id: 'g4',
  src: '/website_pictures/IMG_9904.jpg',
  alt: 'Speaker on stage'
}, {
  id: 'g5',
  src: '/website_pictures/IMG_9905.jpg',
  alt: 'Live performance'
}, {
  id: 'g6',
  src: '/website_pictures/IMG_9911.jpg',
  alt: 'Podium speech'
}, {
  id: 'g7',
  src: '/website_pictures/IMG_9912.jpg',
  alt: 'Youth gathering'
}, {
  id: 'g8',
  src: '/website_pictures/IMG_9913.jpg',
...
const VALUE_BAND_IMAGES = [{
  id: 'vb1',
  src: '/website_pictures/IMG_9898.jpg',
  alt: 'Youth graduation event'
}, {
  id: 'vb2',
  src: '/website_pictures/IMG_9899.jpg',
  alt: 'Large crowd energy'
}, {
  id: 'vb3',
  src: '/website_pictures/IMG_9900.jpg',
  alt: 'Media broadcast'
}];
const TRUST_STATS = [{
  id: 'ts1',
...
const MeshTexture = ({
  ...
  pointerEvents: 'none',
  opacity,
  background: 'radial-gradient(circle at 50% 50%, rgba(201, 160, 68, 0.08) 0%, transparent 80%)'
}} />;
...
const ScrollToTopButton = () => {
  ...
  return <AnimatePresence>
      ...
      top: 0,
      behavior: 'smooth'
    })} aria-label="Scroll to top" className="fixed bottom-6 right-6 z-50 flex items-center justify-center border border-white/20 bg-black/80 backdrop-blur-md p-3 md:p-3.5 hover:border-[#C9A044] hover:text-[#C9A044] text-white/60 transition-all duration-300 rounded-none cursor-pointer">
          <ArrowUp size={16} />
        </motion.button>}
    </AnimatePresence>;
};
          ...
          <div className="hidden lg:grid grid-cols-6 gap-12 items-start">
            ...
            <motion.div {...fadeUp(0.15)} className="col-span-2 flex flex-col gap-3">
              ...
              aspectRatio: '3/4'
                ...
                <img src="/website_pictures/IMG_9887.jpg" alt="Event conference setup" className="w-full h-full object-cover" />
              </div>
              <div className="overflow-hidden border border-white/[0.06]" style={{
              aspectRatio: '16/9'
            }}>
                <img src="/website_pictures/IMG_9888.jpg" alt="Speaker on stage" className="w-full h-full object-cover" />
              </div>
            </motion.div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-8 relative">
            ...
            background: '#111111'
              ...
              background: 'linear-gradient(to bottom, #131313, #111111)'
                ...
                <div aria-hidden="true" className="group-hover:opacity-20 opacity-0 transition-opacity duration-500" style={{
                position: 'absolute',
                inset: 0,
                zIndex: 4,
                background: 'linear-gradient(to bottom, rgba(201,160,68,0.2) 0%, transparent 60%)',
                pointerEvents: 'none'
              }} />
                <div style={{
                position: 'absolute',
